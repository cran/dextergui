		...
		tabPanel('Data import',
		  ...
		  fluidRow(
		    column(width=3, class="col-side-left",
		      tags$div('The data file should contain responses for one testform (booklet).',
		               'Each row in the data file will be interpreted as the responses for a single person.',
		               "The first row should contain column names. Most column names should correspond to item_id's",
		               'that are known in your project. It is also possible to add extra columns which contain person properties,',
		               'e.g. age, schooltype or other variables of interest. It is advisable to add another column named person_id',
		               'which uniquely codes each person. This will prevent you from accidentally entering the same data twice.',
